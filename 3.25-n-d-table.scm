...
;; test
(define t (make-table))
(newline) (display (insert! 'a-single-key 10086 t))
(newline) (display (lookup 'a-single-key t))
(newline) (display (insert! (list 'key-1 'key-2 'key-3) 123 t))
(newline) (display (lookup (list 'key-1 'key-2 'key-3) t))
(newline) (display (insert! (list 'key-1 'key-2 'key-3) 'hello-moto t))
(newline) (display (lookup (list 'key-1 'key-2 'key-3) t))
